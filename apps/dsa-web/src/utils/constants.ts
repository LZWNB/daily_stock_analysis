...
const configuredStaticPreview = import.meta.env.VITE_STATIC_PREVIEW?.trim().toLowerCase();
...
export const STATIC_PREVIEW_MODE = ['1', 'true', 'yes', 'on'].includes(configuredStaticPreview || '');
